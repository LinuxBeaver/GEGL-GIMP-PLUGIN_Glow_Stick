...
property_double (scale, _("Faint Sharpen"), 0.0)
...
GeglProperties *o = GEGL_PROPERTIES (operation);
  GeglNode *input, *output, *nop, *color, *unsharpmask, *gegl1, *bloom, *linearlight, *hardlight, *crop, *lightchroma, *burn, *multiply, *softglow, *hslcolor, *lchcolor, *overlay, *softlight, *grainmerge, *noisereduction;
